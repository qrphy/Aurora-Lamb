    ...
    >
      <div className="max-w-5xl mx-auto px-4 h-full flex items-center justify-between">
        <div className="flex-none">
          <Link
            href="/"
            className="inline-flex items-center text-lg font-bold text-gray-900 dark:text-gray-100 transition"
        ...
        <div className="hidden md:flex flex-none">
          <a
            href="#buy"
            className="bg-blue-600 text-white px-4 py-2 rounded-md font-semibold shadow-sm hover:bg-blue-700"
          >
            Buy Now
          </a>
        </div>
